...
impl App<'_> {
    pub(super) fn render_digest_tab(&mut self, frame: &mut Frame, area: Rect) {
        ...
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_username_text_input, digest_auth_layout[0]);
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_password_text_input, digest_auth_layout[1]);
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_domains_text_input, digest_auth_layout[2]);
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_realm_text_input, digest_auth_layout[3]);
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_nonce_text_input, digest_auth_layout[4]);
        digest_auth_scroll_view.render_widget(&mut self.auth_digest_opaque_text_input, digest_auth_layout[5]);
