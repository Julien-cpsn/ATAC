    ...
    pub fn get_available_events(&self, request_view: RequestView, request_param_tab: RequestParamsTabs, protocol: Option<Protocol>, is_there_any_env: bool) -> Vec<AppEvent> {
        ...
        match self {
            ...
            EditingEnvVariable => [
                ...
                generate_text_input_documentation(key_bindings.generic.text_input.mode, true)
            ].concat(),
            ...
            EditingRequestAuthJwtPayload => [
                ...
                generate_text_input_documentation(key_bindings.generic.text_input.mode, false)
            ].concat(),
            EditingRequestAuthDigestUsername => [
                vec![
...
fn generate_text_input_documentation(text_input_mode: TextAreaMode, single_line: bool) -> Vec<AppEvent> {
    ...
    match text_input_mode {
        TextAreaMode::Vim => {
            if !single_line {
                initial.extend(vec![
                    Documentation(EventKeyBinding::new(vec![key!(ctrl-e)], "System editor", None)),
        ...
        TextAreaMode::Emacs => {
            if !single_line {
                initial.extend(vec![
                    Documentation(EventKeyBinding::new(vec![key!(alt-e)], "System editor", None)),
                ]);
            }
        ...
        TextAreaMode::Custom(custom_text_area_bindings) => {
            initial.extend(vec![
            ...
            initial.extend(vec![
                ...
                Documentation(EventKeyBinding::new(vec![custom_text_area_bindings.search], "Search", Some("Search"))),
            ]);
        }
    }
