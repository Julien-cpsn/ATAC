...
| [serde](https://github.com/serde-rs/serde) ([serde_json](https://github.com/serde-rs/json), [serde-yaml](https://github.com/dtolnay/serde-yaml)) | 1.0.217 (1.0.138, 0.9.34) | Serialize & Deserialize application data into files                                    |
...
| [clap](https://github.com/clap-rs/clap)                                                                                                          | 4.5.29                    | Command Line Argument Parser                                                           |
...
| **Utils**                                                                                                                                        |                           |                                                                                        |
| [strum](https://github.com/Peternator7/strum)                                                                                                    | 0.27.0                    | Enum facilities                                                                        |
...
| [anyhow](https://github.com/dtolnay/anyhow)                                                                                                      | 1.0.95                    | Result that can contain any error                                                      |
| [clap-verbosity-flag](https://github.com/clap-rs/clap-verbosity-flag)                                                                            | 3.0.2                     | Add verbosity flag to the CLI                                                          |
| [clap_complete](https://github.com/clap-rs/clap/tree/master/clap_complete)                                                                       | 4.5.44                    | Generate completion file                                                               |
...
| [uuid](https://github.com/uuid-rs/uuid)                                                                                                          | 1.13.1                    | UUID generator                                                                         |
| **Tracing/Log**                                                                                                                                  |                           |                                                                                        |
