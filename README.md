...
|--------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|----------------------------------------------------------------------------------------|
| **Request**                                                                                                                                      |                   |                                                                                        |
| [reqwest](https://github.com/seanmonstar/reqwest) & [reqwest cookie store](https://github.com/pfernie/reqwest_cookie_store)                      | 0.12.20 & 0.8.0   | Send requests                                                                          |
| **TUI**                                                                                                                                          |                   |                                                                                        |
...
| [image](https://github.com/image-rs/image)                                                                                                       | 0.25.6            | Decode images.                                                                         |
| **Main functionalities**                                                                                                                         |                   |                                                                                        |
| [syntect](https://github.com/trishume/syntect)                                                                                                   | 5.2.0             | Syntax highlighting                                                                    |
| [serde](https://github.com/serde-rs/serde) ([serde_json](https://github.com/serde-rs/json), [serde-yaml](https://github.com/dtolnay/serde-yaml)) | 1.0 (1.0, 0.9.34) | Serialize & Deserialize application data into files                                    |
| [jsonxf](https://github.com/gamache/jsonxf)                                                                                                      | 1.1.1             | Pretty print JSON                                                                      |
| [toml](https://github.com/toml-rs/toml)                                                                                                          | 0.9.1             | Serialize & Deserialize application config files                                       |
...
| [arboard](https://github.com/1Password/arboard)                                                                                                  | 3.6.0             | Copy response body to clipboard                                                        |
| **Async**                                                                                                                                        |                   |                                                                                        |
| [tokio](https://github.com/tokio-rs/tokio)                                                                                                       | 1.46.1            | Handle asynchronous requests                                                           |
...
| [indexmap](https://github.com/indexmap-rs/indexmap)                                                                                              | 2.10.0            | Ordered hashmap. Used in environments to preserve files' values order                  |
| [rayon](https://github.com/rayon-rs/rayon)                                                                                                       | 1.10.0            | Allows the usage of multiple threads in for loops                                      |
| [thiserror](https://github.com/dtolnay/thiserror)                                                                                                | 2.0.12            | Create custom errors                                                                   |
| [anyhow](https://github.com/dtolnay/anyhow)                                                                                                      | 1.0.98            | Result that can contain any error                                                      |
| [clap-verbosity-flag](https://github.com/clap-rs/clap-verbosity-flag)                                                                            | 3.0.3             | Add verbosity flag to the CLI                                                          |
| [clap_complete](https://github.com/clap-rs/clap/tree/master/clap_complete)                                                                       | 4.5               | Generate completion file                                                               |
| [clap_mangen](https://github.com/clap-rs/clap/tree/master/clap_mangen)                                                                           | 0.2               | Generate man pages                                                                     |
...
| [uuid](https://github.com/uuid-rs/uuid)                                                                                                          | 1.17.0            | UUID generator                                                                         |
...
| [reqwest-tracing](https://github.com/TrueLayer/reqwest-middleware/tree/main/reqwest-tracing)                                                     | 0.5.8             | Opentracing middleware implementation for reqwest-middleware                           |
